...
public class MustacheDocumentationGeneratorTest {
    ...
    public void testGenerateDocumentation() throws Exception {
        ...
        assertThat(StringUtils.countMatches(content,
        ...
        assertThat(StringUtils.countMatches(content,
                ...
                is(1));
        assertThat(StringUtils.countMatches(content,
                "|<a name=\"bridge-id-bridge\"></a>bridge |  |  | The bridge number one."), is(1));
        assertThat(StringUtils.countMatches(content,
                "|thermostatId | TEXT | required=false, readOnly=false |  | ID of the Thermostat. |"), is(1));
        assertThat(StringUtils.countMatches(content,
                "<a href=\"#channel-id-roomSetpoint\">roomSetpoint</a>,    <a href=\"#channel-id-heatingMode\">heatingMode</a>,    <a href=\"#channel-id-currentRoomTemperature\">currentRoomTemperature</a>"),
                is(1));
    }
}