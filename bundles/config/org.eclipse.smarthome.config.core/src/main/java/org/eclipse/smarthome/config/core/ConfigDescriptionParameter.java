...
public class ConfigDescriptionParameter {
	...
	public ConfigDescriptionParameter(String name, Type type)
			throws IllegalArgumentException {
		this(name, type, null, null, null, null, false, false, false, null,
	 ...
	 */
	public ConfigDescriptionParameter(String name, Type type,
			BigDecimal minimum, BigDecimal maximum, BigDecimal stepsize,
			String pattern, Boolean required, Boolean readOnly,
		...
		if ((name == null) || (name.isEmpty())) {
			throw new IllegalArgumentException(
					"The name must neither be null nor empty!");
		}
		...
		if (filterCriteria != null)
			...
			this.filterCriteria = Collections
					.unmodifiableList(new LinkedList<FilterCriteria>());
	}
