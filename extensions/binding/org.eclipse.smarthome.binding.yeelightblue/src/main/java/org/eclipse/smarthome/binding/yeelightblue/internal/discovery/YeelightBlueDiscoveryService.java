...
import org.eclipse.smarthome.binding.yeelightblue.YeelightBlueBindingConstants;
...
/**
 * The {@link YeelightBlueDiscoveryService} handles searching for YeeLight Blue Bluetooth lights
 *
 * @author Chris Jackson - Initial Contribution
 *
 */
public class YeelightBlueDiscoveryService extends AbstractDiscoveryService {
    private final Logger logger = LoggerFactory.getLogger(YeelightBlueDiscoveryService.class);
    ...
    public YeelightBlueDiscoveryService() {
        super(SEARCH_TIME);

        logger.debug("Creating Yeelight Blue discovery service");
    }

    @Override
    public Set<ThingTypeUID> getSupportedThingTypes() {
        return Collections.singleton(YeelightBlueBindingConstants.THING_TYPE_YEELIGHT_BLUE);
    }
    ...
    public void startScan() {
        ...
        logger.debug("Start Yeelight Blue LE scan");
        if (adapter == null) {
    ...
    void addDiscoveryResultThing(String thingType, String address, String label, String manufacturer) {
        ...
        properties.put(YeelightBlueBindingConstants.PROPERTY_ADDRESS, address);
        if (manufacturer != null) {
            properties.put(YeelightBlueBindingConstants.PROPERTY_MANUFACTURER, manufacturer);
        }
    ...
    class DiscoveryScanCallback extends ScanCallback {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            thingTypeUID = YeelightBlueBindingConstants.THING_TYPE_YEELIGHT_BLUE.getAsString();
