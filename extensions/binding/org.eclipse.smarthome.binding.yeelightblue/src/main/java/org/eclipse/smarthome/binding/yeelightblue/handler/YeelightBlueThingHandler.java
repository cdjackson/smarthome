 ...
 */
package org.eclipse.smarthome.binding.yeelightblue.handler;
...
/**
 * The {@link YeelightBlueThingHandler} is the handler for the YeeLight Blue bluetooth light.
 *
 * @author Chris Jackson - Initial Contribution
 */
public class YeelightBlueThingHandler extends BaseThingHandler {
    ...
    public void initialize() {
        ...
        address = this.getThing().getProperties().get(YeelightBlueBindingConstants.PROPERTY_ADDRESS);
        if (address == null) {
    ...
    class GattCallback extends BluetoothGattCallback {
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            ...
            updateState(new ChannelUID(getThing().getUID(), YeelightBlueBindingConstants.CHANNEL_RSSI),
